...
- Have the legal capacity to enter this agreement in your jurisdiction. If you don't have legal capacity (for example, you're between 16 and the age of majority where you live), you confirm that a parent or guardian has reviewed these Terms with you.
...
- Tell us promptly if you suspect someone else is using your account.
...
- Post unlawful, defamatory, harassing, hateful, or threatening content.
- Impersonate another person, roaster, or business.
- Use dial to harass, dox, or target other users.
- Scrape, mirror, or republish dial's data at scale without our permission.
- Reverse-engineer, decompile, or interfere with how dial works (except where the law explicitly allows it).
- Use dial to spam, distribute malware, or commit fraud.
- Falsely claim affiliation with a roaster.
...
- Edit honestly. Don't claim attributes (origin, process, variety) you can't verify.
...
- We make no warranty that dial will be uninterrupted, error-free, or that the data shown (coffees, roasters, brew advice, recipes) is accurate or fit for any particular purpose.
- Brew advice, recipes, and TDS/EY measurements are user-generated or informational. They're not professional advice. Use your judgment.
- We don't warrant that user-contributed roaster or coffee information is accurate.
...
- Purchases will have their own subscription terms presented at the point of purchase.
- You must be **18 or older** to make a purchase.
- Purchases made through Apple's App Store or Google Play are also subject to those platforms' terms, including their refund policies.
...
Questions about these Terms: [dial.brews@gmail.com](mailto:dial.brews@gmail.com).
